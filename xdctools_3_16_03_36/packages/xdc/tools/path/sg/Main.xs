...
var w_display, w_shell, w_composite, w_menubar, w_Table, w_statusComposite,
     ...
     w_pathComposite, w_packagesComposite;
...
function _parseEnvPath()
{
    ...
    var packagepath = environment['xdc.path'];
    packagepath = _cleanPath(packagepath);
    ...
    var xdcpath = pathArr.join(';').replace(/\\/g, '/');
    curxdcpath = xdcpath;

    //print("pathsuffix = " + pathsuffix);
    //print("xdcroot    = " + xdcroot);
    //print("hat        = " + hat);
}
