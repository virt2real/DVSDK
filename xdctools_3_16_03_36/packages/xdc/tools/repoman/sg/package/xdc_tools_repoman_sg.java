...
public class xdc_tools_repoman_sg
{
    ...
    void Main$$FUNCTIONS()
    {
        ...
        // fxn Main.main
        fxn = (Proto.Fxn)om.bind("xdc.tools.repoman.sg.Main$$main", new Proto.Fxn(om.findStrict("xdc.tools.repoman.sg.Main.Module", "xdc.tools.repoman.sg"), null, 0, -1, false));
    }
    ...
    void Main$$TYPES()
    {
        ...
        po.init("xdc.tools.repoman.sg.Main.Module", $$Module);
                ...
                po.addFxn("main", (Proto.Fxn)om.findStrict("xdc.tools.repoman.sg.Main$$main", "xdc.tools.repoman.sg"), Global.get(cap, "main"));
    }
