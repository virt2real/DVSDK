...
public class xdc_tools_configuro
{
    ...
    void Main$$TYPES()
    {
        ...
        po.init("xdc.tools.configuro.Main.Module", om.findStrict("xdc.tools.ICmd.Module", "xdc.tools.configuro"));
                ...
                po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{"[-v]", "[-@ optionsfile]", "[-o outdir]", "[-b config_bld | -c codegen_dir | --cb]", "[-t target] [-p platform[:instance]] [-r profile]", "[-Dname=value]", "[-w | -x regexp]", "[--rtsName pkg_name]", "[--cfgArgs args_string]", "[--linkTemplate linker_template]", "[--tcf] [--bios5] [--pkg]", "[--compileOptions compile_options_string]", "[--oc compiler.opt] [--ol linker.cmd]", "infile.cfg"}), "wh");
