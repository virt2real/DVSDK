...
public class ti_platforms_simTesla
{
    ...
    void Platform$$TYPES()
    {
        ...
        po.init("ti.platforms.simTesla.Platform.Module", om.findStrict("xdc.platform.IPlatform.Module", "ti.platforms.simTesla"));
                ...
                po.addFld("CPU", (Proto)om.findStrict("xdc.platform.IExeContext.Cpu", "ti.platforms.simTesla"), Global.newObject("id", "0", "clockRate", 466L, "catalogName", "ti.catalog.c6000.nda", "deviceName", "Tesla", "revision", "1.0"), "rh");
