...
public class ti_catalog_msp430_init
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/Boot.a430XL',\n");
            sb.append("'lib/Boot.a430',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/Boot.a430X', {target: 'ti.targets.MSP430_large_code'}],\n");
            sb.append("['lib/Boot.a430XL', {target: 'ti.targets.MSP430_large_data'}],\n");
            sb.append("['lib/Boot.a430', {target: 'ti.targets.MSP430'}],\n");
        sb.append("];\n");
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            sb.append("pkg.build.libDesc['lib/Boot.a430X'].suffix = '430X';\n");
            sb.append("pkg.build.libDesc['lib/Boot.a430XL'].suffix = '430XL';\n");
            sb.append("pkg.build.libDesc['lib/Boot.a430'].suffix = '430';\n");
        sb.append("}\n");
