/****************************************************************
 *  TI CCS-based NAND Flashing utility for DM643x               *
...
4.  Load the NANDWriter.out file (located in \build\debug).
5.  Run the program.
...
10. Remove power, change bootmode switches to NAND Fastboot.
