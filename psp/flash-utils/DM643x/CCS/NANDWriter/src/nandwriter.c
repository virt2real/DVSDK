...
extern __FAR__ Uint32 NANDStart;
...
static Uint32 nandwriter()
{
  ...
  DEBUG_printString("Starting DM643x NANDWriter.\r\n");


  AEMIF->AB1CR = 0x3FFFFFFC;
...
#else
  // Temp code for loading the MOS demo
  //aisFileSize = 27926528;
  aisFileSize = 4*1024*1024;
  aisPtr = (Uint8 *) 0x80000000;
