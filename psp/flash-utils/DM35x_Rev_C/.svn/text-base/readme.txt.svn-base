The DM35x_RevC directory contains files needed for the DM335, DM350, and DM355 devices (Silicon Revision 1.3).  Silicon revision 1.3 is sometimes referred to as revision C.
