...
static Uint32 i2cwriter()
{
  ...
  DEBUG_printString( "Starting C672x_I2CWriter.\r\n");

  // Initialize I2C Flash
  //hI2cMemInfo = I2C_MEM_open(0,0x29,0x50);
  hI2cMemInfo = I2C_MEM_open(1,0x29,0x50);
  if (hI2cMemInfo == NULL)
  {
  ...
  if (strcmp(fileName,"none") != 0)
  {
    ...
    else if ( appFileSize > hI2cMemInfo->memorySize)
    {
    ...
    // Erase the I2C flash to accomadate the file size
#if (0)
