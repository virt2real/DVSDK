/* --------------------------------------------------------------------------
  ...
  MODIFIED	  : Sandeep Paulraj 10/28/2008 to add support for DM357
  DESC        : This file provides low-level, device-specific init functions
                for use the DM357 device
-------------------------------------------------------------------------- */ 
...
\***********************************************************/
    ...
    static const Uint32 PLL1_Mult = 20;  // DSP=540 MHz and ARM =270 Mhz
...
Uint32 DEVICE_init()
{
  ...
  SYSTEM->PINMUX[0] = 0x80000c1f;
  SYSTEM->PINMUX[1] = 0x000406f1;
...
// DM357 has a second NAND at 0x6000000
	AEMIF->AB3CR =  0
        | ( 0  << 31 )      
        | ( 0  << 30 )      
        | ( 15 << 26 )      
