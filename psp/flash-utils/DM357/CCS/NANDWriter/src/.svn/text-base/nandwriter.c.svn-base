...
static Uint32 nandwriter()
{
  ...
  DEBUG_printString("Starting DM357_NANDWriter.\r\n");
  ...
  if (strcmp(fileName,"none") != 0)
  {
    ...
    {
      DEBUG_printString("\tWARNING: Entry point not in acceptable range - using default 0x82080000.\r\n");
      gNandBoot.entryPoint = 0x82080000;
    }
    else
    {
    ...
    {
      DEBUG_printString("\tWARNING: Load address not in acceptable range - using default 0x82080000.\r\n");
      gNandBoot.ldAddress = 0x82080000;
    }
