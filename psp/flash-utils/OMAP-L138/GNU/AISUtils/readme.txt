/****************************************************************
 *  TI DM643x AIS Utilities                                     *
 *  (C) 2007, Texas Instruments, Inc.                           *
 *                                                              *
 * History: 19-Feb-2008 - v1.01 release                         *
 *                                                              *
 ****************************************************************/
 
This directory contains the source for the HexAIS and GenAIS utilities
for the DM643x device family. The HexAIS utility is intended to produce
...
DM643x_NORWriter CCS project.  The binary AIS could also be processed by 
...
For the HexAIS utility, the available options include:
 ...
 -coff2hex               Process the input file as a valid COFF file, internally generate the
                         AIS format, then convert to hex output (requires DM643x.ini file).
