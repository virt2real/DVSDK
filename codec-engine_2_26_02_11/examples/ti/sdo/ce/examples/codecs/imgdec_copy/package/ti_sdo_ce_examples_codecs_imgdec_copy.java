...
public class ti_sdo_ce_examples_codecs_imgdec_copy
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/imgdec_copy.a470uC',\n");
            sb.append("'lib/imgdec_copy.a86U',\n");
            sb.append("'lib/imgdec_copy.a674',\n");
            sb.append("'lib/imgdec_copy.a64P',\n");
            sb.append("'lib/imgdec_copy.av4TCE',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/imgdec_copy.av5T', {target: 'gnu.targets.arm.GCArmv5T'}],\n");
            sb.append("['lib/imgdec_copy.a470uC', {target: 'gnu.targets.UCArm9'}],\n");
            sb.append("['lib/imgdec_copy.a86U', {target: 'gnu.targets.Linux86'}],\n");
            sb.append("['lib/imgdec_copy.a674', {target: 'ti.targets.C674'}],\n");
            sb.append("['lib/imgdec_copy.a64P', {target: 'ti.targets.C64P'}],\n");
            sb.append("['lib/imgdec_copy.av4TCE', {target: 'microsoft.targets.arm.WinCE'}],\n");
        sb.append("];\n");
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            sb.append("pkg.build.libDesc['lib/imgdec_copy.av5T'].suffix = 'v5T';\n");
            sb.append("pkg.build.libDesc['lib/imgdec_copy.a470uC'].suffix = '470uC';\n");
            sb.append("pkg.build.libDesc['lib/imgdec_copy.a86U'].suffix = '86U';\n");
            sb.append("pkg.build.libDesc['lib/imgdec_copy.a674'].suffix = '674';\n");
            sb.append("pkg.build.libDesc['lib/imgdec_copy.a64P'].suffix = '64P';\n");
            sb.append("pkg.build.libDesc['lib/imgdec_copy.av4TCE'].suffix = 'v4TCE';\n");
        sb.append("}\n");
