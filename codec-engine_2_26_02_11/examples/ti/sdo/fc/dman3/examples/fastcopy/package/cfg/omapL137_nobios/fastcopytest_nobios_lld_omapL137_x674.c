 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/fc/fc-p01x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/omapL137_nobios/fastcopytest_nobios_lld_omapL137_x674");
...
__FAR__ Uns DMAN3_QDMA_CHANNELS[1] = {
    1
};

__FAR__ Uns DMAN3_QDMA_QUEUE_MAP[1] = {
    1
};
