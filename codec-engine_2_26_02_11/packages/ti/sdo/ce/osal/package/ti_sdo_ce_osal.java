...
public class ti_sdo_ce_osal
{
    ...
    void Global$$CONSTS()
    {
        ...
        om.bind("ti.sdo.ce.osal.Global.DEFAULT_ARMDSPLINKCONFIG", Global.newObject("memTable", Global.newArray(new Object[]{Global.newArray(new Object[]{"DDRALGHEAP", Global.newObject("addr", 0x88000000L, "size", 0x07A00000L, "type", "other")}), Global.newArray(new Object[]{"DDR2", Global.newObject("addr", 0x8FA00000L, "size", 0x00400000L, "type", "main")}), Global.newArray(new Object[]{"DSPLINKMEM", Global.newObject("addr", 0x8FE00000L, "size", 0x00100000L, "type", "link")}), Global.newArray(new Object[]{"RESETCTRL", Global.newObject("addr", 0x8FF00000L, "size", 0x00000080L, "type", "reset")})}), "doPowerControl", false));
    }
    ...
    void IOsal$$FUNCTIONS()
    {
        ...
        // fxn IOsal.supportsLogging
        fxn = (Proto.Fxn)om.bind("ti.sdo.ce.osal.IOsal$$supportsLogging", new Proto.Fxn(om.findStrict("ti.sdo.ce.osal.IOsal.Module", "ti.sdo.ce.osal"), $$T_Bool, 0, 0, false));
    }
    ...
    void Global$$TYPES()
    {
        ...
        po.init("ti.sdo.ce.osal.Global.Module", $$Module);
                ...
                po.addFld("DEFAULT_ARMDSPLINKCONFIG", (Proto)om.findStrict("ti.sdo.ce.ipc.IIpc.ArmDspLinkConfig", "ti.sdo.ce.osal"), Global.newObject("memTable", Global.newArray(new Object[]{Global.newArray(new Object[]{"DDRALGHEAP", Global.newObject("addr", 0x88000000L, "size", 0x07A00000L, "type", "other")}), Global.newArray(new Object[]{"DDR2", Global.newObject("addr", 0x8FA00000L, "size", 0x00400000L, "type", "main")}), Global.newArray(new Object[]{"DSPLINKMEM", Global.newObject("addr", 0x8FE00000L, "size", 0x00100000L, "type", "link")}), Global.newArray(new Object[]{"RESETCTRL", Global.newObject("addr", 0x8FF00000L, "size", 0x00000080L, "type", "reset")})}), "doPowerControl", false), "rh");
                po.addFld("os", (Proto)om.findStrict("ti.sdo.ce.osal.IOsal.Module", "ti.sdo.ce.osal"), $$UNDEF, "wh");
                po.addFld("armDspLinkConfig", (Proto)om.findStrict("ti.sdo.ce.ipc.IIpc.ArmDspLinkConfig", "ti.sdo.ce.osal"), $$DEFAULT, "wh");
    ...
    void IOsal$$TYPES()
    {
        ...
        cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "ti/sdo/ce/osal/IOsal.xs");
        om.bind("ti.sdo.ce.osal.IOsal$$capsule", cap);
        po = (Proto.Obj)om.findStrict("ti.sdo.ce.osal.IOsal.Module", "ti.sdo.ce.osal");
        po.init("ti.sdo.ce.osal.IOsal.Module", $$Module);
                po.addFld("$hostonly", $$T_Num, 1, "r");
                fxn = Global.get(cap, "module$use");
                if (fxn != null) om.bind("ti.sdo.ce.osal.IOsal$$module$use", true);
                if (fxn != null) po.addFxn("module$use", $$T_Met, fxn);
                fxn = Global.get(cap, "module$meta$init");
                if (fxn != null) om.bind("ti.sdo.ce.osal.IOsal$$module$meta$init", true);
                if (fxn != null) po.addFxn("module$meta$init", $$T_Met, fxn);
                fxn = Global.get(cap, "module$validate");
                if (fxn != null) om.bind("ti.sdo.ce.osal.IOsal$$module$validate", true);
                if (fxn != null) po.addFxn("module$validate", $$T_Met, fxn);
                fxn = Global.get(cap, "supportsLogging");
                if (fxn != null) po.addFxn("supportsLogging", (Proto.Fxn)om.findStrict("ti.sdo.ce.osal.IOsal$$supportsLogging", "ti.sdo.ce.osal"), fxn);
    }
    ...
    void IOsal$$SINGLETONS()
    {
        ...
        vo.bind("$capsule", om.findStrict("ti.sdo.ce.osal.IOsal$$capsule", "ti.sdo.ce.osal"));
        vo.bind("$package", om.findStrict("ti.sdo.ce.osal", "ti.sdo.ce.osal"));
        tdefs.clear();
        proxies.clear();
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
