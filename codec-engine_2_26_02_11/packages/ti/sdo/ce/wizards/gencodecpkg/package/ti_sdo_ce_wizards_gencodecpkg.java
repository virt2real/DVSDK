...
public class ti_sdo_ce_wizards_gencodecpkg
{
    ...
    void Main$$TYPES()
    {
        ...
        po.init("ti.sdo.ce.wizards.gencodecpkg.Main.Module", om.findStrict("xdc.tools.ICmd.Module", "ti.sdo.ce.wizards.gencodecpkg"));
                ...
                po.addFld("usage", new Proto.Arr($$T_Str, false), Global.newArray(new Object[]{"[-g] [--xdais <xdais_dir>] [--cgtools <dir>] [--v5tcgtools <dir>] [-f <file> | --xml <file>]  [-d <destination dir>]"}), "wh");
