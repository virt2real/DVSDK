...
#define BIT_10_MASK         0x00000400 //DM360 change

#define KAL2HOST_INT		10  //DM360 changed
/* Priority 7 - lowest */

#define PRIORITY_7			0x7
/* Kaliedo to Host interrupt priority - lower priority
 * maps to IRQ */
#define KAL2HOST_INT_PRI	0x00000700 //DM360 changed

/* Alternate  Kaliedo to Host interrupt priority
 * maps to FIQ */
#define KAL2HOST_INT_PRI_1	0xFFFFF9FF //DM360 Changed
