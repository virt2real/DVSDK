...
/* ARM926 INTC registers: For details, see section 8 of DM365 ARM subsystem
...
//#define BIT_10_MASK         0x00000400 //DM365 change
#define BIT_9_MASK         0x00000200 //DM365 change

//#define KAL2HOST_INT		10  //DM365 changed
#define MJCP2HOST_INT		9  //DM365 changed
/* Priority 7 - lowest */

#define PRIORITY_7			0x7
/* Kaliedo to Host interrupt priority - lower priority
 * maps to IRQ */
//#define KAL2HOST_INT_PRI	0x00000700 //DM365 changed
#define MJCP2HOST_INT_PRI	0x00000070 //DM365 changed

/* Alternate  Kaliedo to Host interrupt priority
 * maps to FIQ */
//#define KAL2HOST_INT_PRI_1	0xFFFFF9FF //DM365 Changed
#define MJCP2HOST_INT_PRI_1	0xFFFFFF9F //DM365 Changed
