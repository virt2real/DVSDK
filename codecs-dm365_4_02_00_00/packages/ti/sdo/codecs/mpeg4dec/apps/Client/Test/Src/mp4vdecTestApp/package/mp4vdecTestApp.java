...
public class mp4vdecTestApp
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("mp4vdecTestApp.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("mp4vdecTestApp", new Value.Obj("mp4vdecTestApp", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("mp4vdecTestApp.Package", (Proto.Obj)om.find("xdc.IPackage.Module"));
        Scriptable cap = (Scriptable)Global.callFxn("loadCapsule", xdcO, "mp4vdecTestApp/package.xs");
        ...
        pkgV.init2(pkgP, "mp4vdecTestApp", Value.DEFAULT, false);
        pkgV.bind("$name", "mp4vdecTestApp");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "mp4vdecTestApp.");
        ...
        sb.append("var pkg = xdc.om['mp4vdecTestApp'];\n");
