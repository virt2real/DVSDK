...
static String encoderName  = "aaclc_enc";
static String engineName   = "aaclc_enc_engine";
...
int ceapp_init(void *params)
{
    ...
    encHandle = AUDENC1_create(ceHandle, encoderName, params);
    if (encHandle == NULL) {
