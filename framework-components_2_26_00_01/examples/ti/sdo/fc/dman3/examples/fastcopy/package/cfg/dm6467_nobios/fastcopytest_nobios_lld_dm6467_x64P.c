 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/fc/fc-p01x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/dm6467_nobios/fastcopytest_nobios_lld_dm6467_x64P");
 ...
 */
xdc__META(__PLAT__, "@(#)__PLAT__ = ti.platforms.evmDM6467");
...
__FAR__ Uns DMAN3_QUEUE_TC_MAP[4] = {
    0,
    1,
    2,
    3
...
__FAR__ Uns DMAN3_QUEUE_PRIORITIES[4] = {
    3,
    7,
    0,
    0
