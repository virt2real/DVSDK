 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/fc/fc-p01x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/3530_nobios/fastcopytest_nobios_lld_3530_x64P");
...
__FAR__ Uns DMAN3_QUEUE_TC_MAP[2] = {
    0,
    1
};

__FAR__ Uns DMAN3_QUEUE_PRIORITIES[2] = {
    3,
    7
};
