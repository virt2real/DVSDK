 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/fc/fc-p01x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/dm6467_bios/fastcopytest_lld_dm6467_x64P");
...
/* Region configuration initialization information for the EDMA3 Low level
   Resource Manager */
extern __FAR__ EDMA3_InstanceInitConfig myRegionConfig;
