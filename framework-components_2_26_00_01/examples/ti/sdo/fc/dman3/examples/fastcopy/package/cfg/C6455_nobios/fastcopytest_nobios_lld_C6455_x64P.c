 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/fc/fc-p01x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/C6455_nobios/fastcopytest_nobios_lld_C6455_x64P");
 ...
 */
xdc__META(__PLAT__, "@(#)__PLAT__ = ti.platforms.dsk6455");
...
__FAR__ Uns DMAN3_QDMA_CHANNELS[5] = {
    0,
    1,
    2,
    3,
...
__FAR__ Uns DMAN3_QDMA_QUEUE_MAP[5] = {
    1,
    1,
    1,
    1,
