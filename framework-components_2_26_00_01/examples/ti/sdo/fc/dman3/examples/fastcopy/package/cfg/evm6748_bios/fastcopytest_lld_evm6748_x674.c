 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /db/atree/library/trees/fc/fc-p01x/src/ti/sdo/fc/dman3/examples/fastcopy/package/cfg/evm6748_bios/fastcopytest_lld_evm6748_x674");
...
__FAR__ Uns ti_sdo_fc_edma3_EDMA3_physicalId = 1;
