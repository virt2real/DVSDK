...
public class ti_sdo_fc_dskt2
{
    ...
    void DSKT2$$TYPES()
    {
        ...
        po.init("ti.sdo.fc.dskt2.DSKT2.Module", $$Module);
                ...
                po.addFld("DEFAULTSEG", $$T_Str, "IRAM", "rh");
                po.addFld("DARAM0", $$T_Str, "IRAM", "wh");
                po.addFld("DARAM1", $$T_Str, "IRAM", "wh");
                po.addFld("DARAM2", $$T_Str, "IRAM", "wh");
                po.addFld("SARAM0", $$T_Str, "IRAM", "wh");
                po.addFld("SARAM1", $$T_Str, "IRAM", "wh");
                po.addFld("SARAM2", $$T_Str, "IRAM", "wh");
                po.addFld("ESDATA", $$T_Str, "IRAM", "wh");
                po.addFld("IPROG", $$T_Str, "IRAM", "wh");
                po.addFld("EPROG", $$T_Str, "IRAM", "wh");
                po.addFld("DSKT2_HEAP", $$T_Str, "IRAM", "wh");
                ...
                po.addFld("cacheWritebackInvalidateFxn", $$T_Str, "BCACHE_wbInv", "wh");
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/trace/dskt2.a674',\n");
            sb.append("'lib/trace/dskt2.a64P',\n");
            sb.append("'lib/debug_trace/dskt2.a674',\n");
            sb.append("'lib/debug_trace/dskt2.a64P',\n");
            sb.append("'lib/release/dskt2.a674',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/release/dskt2.a64P', {target: 'ti.targets.C64P'}],\n");
            sb.append("['lib/debug/dskt2.a674', {target: 'ti.targets.C674'}],\n");
            sb.append("['lib/debug/dskt2.a64P', {target: 'ti.targets.C64P'}],\n");
            sb.append("['lib/trace/dskt2.a674', {target: 'ti.targets.C674'}],\n");
            sb.append("['lib/trace/dskt2.a64P', {target: 'ti.targets.C64P'}],\n");
            sb.append("['lib/debug_trace/dskt2.a674', {target: 'ti.targets.C674'}],\n");
            sb.append("['lib/debug_trace/dskt2.a64P', {target: 'ti.targets.C64P'}],\n");
            sb.append("['lib/release/dskt2.a674', {target: 'ti.targets.C674'}],\n");
        sb.append("];\n");
        sb.append("if('suffix' in xdc.om['xdc.IPackage$$LibDesc']) {\n");
            sb.append("pkg.build.libDesc['lib/release/dskt2.a64P'].suffix = '64P';\n");
            sb.append("pkg.build.libDesc['lib/debug/dskt2.a674'].suffix = '674';\n");
            sb.append("pkg.build.libDesc['lib/debug/dskt2.a64P'].suffix = '64P';\n");
            sb.append("pkg.build.libDesc['lib/trace/dskt2.a674'].suffix = '674';\n");
            sb.append("pkg.build.libDesc['lib/trace/dskt2.a64P'].suffix = '64P';\n");
            sb.append("pkg.build.libDesc['lib/debug_trace/dskt2.a674'].suffix = '674';\n");
            sb.append("pkg.build.libDesc['lib/debug_trace/dskt2.a64P'].suffix = '64P';\n");
            sb.append("pkg.build.libDesc['lib/release/dskt2.a674'].suffix = '674';\n");
        sb.append("}\n");
